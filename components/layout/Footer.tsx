            ...
            <div className="max-w-7xl mx-auto px-6 lg:px-8">
                    ...
                    <div className="flex flex-wrap items-center gap-x-8 gap-y-4">
                        ...
                        <div className="flex flex-wrap gap-x-6 gap-y-2">
                            {['Vehicles', 'Motorcycles', 'Furniture', 'Freight', 'Boats', 'Heavy Equipment'].map((link) => (
                                <Link key={link} href="/register" className="text-sm font-bold text-purple-400 hover:text-[#7C3AED] transition-colors">
                                    {link}
                                </Link>
                            ))}
                        </div>
                    ...
                    <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-8">
                        <div className="flex flex-wrap items-center gap-x-8 gap-y-4">
                            {[
                                ...
                                <Link key={item.label} href={item.href} className="text-sm font-[900] uppercase tracking-widest hover:text-[#7C3AED] transition-colors">
                                    {item.label}
                                </Link>
                            ))}
                        </div>
                ...
                <div className="flex flex-col lg:flex-row justify-between items-center gap-6">
                    ...
                    <div className="flex flex-wrap justify-center gap-x-6 gap-y-2">
                        {[
                            { label: 'pickitup User Agreement', href: '/terms' },
                            ...
                            <div key={item.label} className="flex items-center gap-6">
                                <Link href={item.href} className="text-[13px] font-bold text-purple-400 hover:text-[#7C3AED] transition-colors">
                                    {item.label}
                                </Link>
