                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
                    ...
                    <div className="flex flex-col items-center text-center lg:items-start lg:text-left">
                            ...
                            {benefits.map((benefit, index) => (
                                <div key={index} className="flex gap-4 group items-start">
                                    ...
                                    <div className="pt-0.5">
                                        <h3 className="text-[16px] font-bold text-[#1a1b3a] mb-0.5 tracking-tight uppercase text-left">
                                            {benefit.title}
                                        </h3>
                                        <p className="text-[14px] text-[#6B7280] font-medium leading-[1.4] max-w-sm text-left">
                                            {benefit.description}
                                        </p>
                                    </div>
                                </div>
                        ...
                        <div className="flex flex-wrap justify-center lg:justify-start gap-4 mb-9 w-full">
                            <Link href="/register?role=carrier" className="bg-yellow-400 hover:bg-yellow-500 text-[#1a1b3a] font-bold px-7 py-3.5 rounded-xl transition-all shadow-lg shadow-yellow-400/20 flex items-center gap-2 text-[15px]">
                                Get Started
                                <span>→</span>
                            </Link>
