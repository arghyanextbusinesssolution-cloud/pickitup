                ...
                <div className="grid lg:grid-cols-2 gap-16 items-center">
                    ...
                    <div className="order-2 lg:order-1 max-w-xl flex flex-col items-center text-center lg:items-start lg:text-left mx-auto lg:mx-0">
                        ...
                        <div className="flex justify-center lg:justify-start w-full">
                            <Link href="/register?type=business" className="bg-yellow-400 hover:bg-yellow-500 text-[#1a1b3a] font-[900] px-10 py-5 rounded-xl transition-all shadow-xl shadow-yellow-400/20 flex items-center gap-3 group text-sm uppercase tracking-widest text-center lg:text-left">
