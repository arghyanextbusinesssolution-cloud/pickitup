    ...
    const services = [
        {
            ...
            description: "Reliable nationwide auto shipping that delivers cars, SUVs, RVs, trailers, and auto components in a timely and safe manner.",
            link: '/register',
        },
        {
            theme: 'yellow',
            ...
            title: 'Shipping for Homes and Furniture',
            tags: [
                { icon: '🛋️', text: 'Furniture' },
                { icon: '📦', text: 'Boxes' },
                { icon: '🔨', text: 'Antiques' }
            ],
            description: "Expert transportation options for boxes, furniture, appliances, antiques, and fragile home goods.",
            link: '/register',
        },
        {
            theme: 'purple',
            ...
            title: 'LTL Transportation Services',
            tags: [
                { icon: '📦', text: 'Pallets' },
                { icon: '🏢', text: 'Commercial' },
                { icon: '📑', text: 'LTL/FTL' }
            ],
            description: "LTL and FTL freight shipping options that are affordable for industrial and commercial shipments.",
            link: '/register',
        },
        {
            theme: 'yellow',
            ...
            title: 'Services for Boat Shipping',
            tags: [
                { icon: '⛵', text: 'Sailboats' },
                { icon: '🚤', text: 'Yachts' },
                { icon: '⚓', text: 'Trailers' }
            ],
            description: "Nationwide sailboat, yacht, trailer, and personal watercraft transportation services that are safe.",
            link: '/register',
        },
        {
            theme: 'purple',
            ...
            title: 'Shipping Services for Motorcycles',
            tags: [
                { icon: '🏍️', text: 'Bikes' },
                { icon: '🏁', text: 'ATVs' },
                { icon: '📦', text: 'Crated' }
            ],
            description: "dependable motorcycle transportation with options for both open and enclosed carriers for optimal security.",
            link: '/register',
        },
        {
            theme: 'yellow',
            ...
            title: 'Shipping of Heavy Equipment',
            tags: [
                { icon: '🚜', text: 'Construction' },
                { icon: '🏗️', text: 'Industrial' },
                { icon: '⚙️', text: 'Oversized' }
            ],
            description: "specialized transportation services for large heavy machines, industry, and construction.",
            link: '/register',
        },
    ];
            ...
            <div className="relative max-w-7xl mx-auto px-6 lg:px-8">
                ...
                <div className="text-center mb-20">
                    ...
                    <p className="text-xl text-gray-500 font-medium max-w-2xl mx-auto leading-relaxed">
                        Discover cost insights, shipping advice, and professional guidance for cars, furniture, freight, and large equipment.
                    </p>
                </div>
                        ...
                        return (
                            ...
                            >
                                ...
                                <div className="relative inline-block mb-4">
                                    ...
                                    <div className={`h-[2px] w-0 group-hover:full transition-all duration-500 mt-1 opacity-50 ${style.underline}`} />
                                ...
                                <div className="mt-auto">
                                    <Link href={service.link} className={`${style.btnBg} text-white font-black px-8 py-4 rounded-xl transition-all shadow-lg flex items-center justify-center gap-2 group/btn text-sm uppercase tracking-widest w-full ${style.btnShadow}`}>
                                        Learn more
