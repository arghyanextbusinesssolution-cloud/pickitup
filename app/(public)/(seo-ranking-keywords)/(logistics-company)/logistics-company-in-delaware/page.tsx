...
export const metadata: Metadata = {
    title: 'Trusted Logistics Company in Delaware | PickItUp',
    description: 'Looking for a trusted logistics company in Delaware? PickItUp provides reliable freight opportunities, transparent load information, and a simple booking process.',
};

export default function DelawareLogisticsPage() {
    const regionalFaqs = [
        {
        ...
        {
            question: "Do you offer shipments outside Delaware?",
            answer: "Yes. As a leading Logistics Company in Delaware, PickItUp supports freight transportation across the United States through an extensive carrier network."
        },
        {
            question: "I\'m searching for a Logistics Company Near Me. Can PickItUp help?",
            answer: "Absolutely. If you\'re looking for a Logistics Company Near Me, PickItUp connects businesses and professional carriers across Delaware with reliable freight opportunities, efficient shipment management, and nationwide transportation solutions."
        },
        {
                    ...
                    <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
                        <div className="flex flex-col items-center text-center lg:items-start lg:text-left">
                            <div className="inline-flex items-center gap-2 bg-purple-50 border border-purple-200 px-4 py-1.5 rounded-full mb-6 shadow-sm">
                                <span className="text-purple-600 text-[11px] font-black tracking-widest uppercase">Logistics Company in Delaware</span>
                            </div>

                            <h1 className="text-[42px] lg:text-[58px] font-[900] text-[#1a1b3a] leading-[1.1] mb-6 tracking-tighter uppercase">
                                Trusted Logistics Company <span className="text-transparent bg-clip-text bg-gradient-to-r from-yellow-400 to-yellow-600">in Delaware</span>
                            </h1>
                        ...
                        <div className="relative flex items-center justify-center">
                            <div className="w-full relative aspect-[4/3] rounded-[2.5rem] overflow-hidden shadow-[0_45px_90px_-20px_rgba(250,204,21,0.25)] border-4 border-white">
                                <Image
                                    src="/freight.jpg"
                                    alt="Logistics Company in Delaware"
                                    fill
                    ...
                    <div className="grid lg:grid-cols-12 gap-12 items-start">
                        <div className="lg:col-span-7">
                            ...
                            <p className="text-lg text-gray-600 leading-relaxed font-medium mb-6">
                                As a leading Logistics Company in Delaware, PickItUp helps carriers maximize efficiency with dependable freight opportunities and streamlined logistics management. Our technology-driven platform connects qualified carriers with businesses seeking reliable transportation and freight solutions throughout Delaware and across the United States.
                            </p>
            ...
            <section className="py-20 lg:py-24 bg-gray-50 border-b border-gray-100">
                <div className="max-w-[1240px] mx-auto px-6 lg:px-10 text-center">
                    ...
                    <p className="text-lg text-gray-600 leading-relaxed font-medium max-w-3xl mx-auto mb-6">
                        Thousands of businesses and transportation professionals rely on PickItUp, a trusted Logistics Company in Delaware, for dependable logistics solutions, freight matching, and nationwide delivery services. 
                    </p>
                    ...
                    <div className="mt-12 bg-white rounded-3xl p-10 shadow-lg border border-gray-100 max-w-4xl mx-auto">
                        ...
                        <p className="text-lg text-gray-600 leading-relaxed font-medium">
                            From local deliveries across Delaware to nationwide freight transportation, our platform helps carriers maximize vehicle utilization, reduce empty miles, and increase revenue through a trusted logistics network.
                        </p>
                    </div>
            ...
            <section className="py-24 bg-[#1a1b3a] text-white">
                <div className="max-w-[1240px] mx-auto px-6 lg:px-10 text-center">
                    ...
                    <p className="text-xl text-gray-300 font-medium max-w-3xl mx-auto mb-6">
                        Join PickItUp and connect with businesses looking for dependable transportation partners. As a trusted Logistics Company in Delaware, we help carriers access available shipments, manage deliveries efficiently, and expand their business through a reliable nationwide freight network.
                    </p>
