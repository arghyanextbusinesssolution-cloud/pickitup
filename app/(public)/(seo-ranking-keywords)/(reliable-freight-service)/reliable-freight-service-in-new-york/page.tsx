...
export const metadata: Metadata = {
    title: 'Reliable Freight Service in New York | PickItUp',
    description: 'Looking for reliable freight service in New York? PickItUp offers fast, secure, and affordable freight shipping solutions for businesses and individuals.',
};

export default function NewYorkFreightPage() {
    const nyFaqs = [
        {
        ...
        {
            question: "Do you provide Freight Service in New York?",
            answer: "Yes. PickItUp specializes in Freight Service in New York, offering local, regional, and nationwide transportation solutions for businesses across multiple industries."
        },
        {
            question: "Can I find Freight Service Near Me through PickItUp?",
            answer: "Absolutely. If you're looking for Freight Service Near Me, PickItUp provides reliable freight transportation throughout New York with flexible scheduling and professional support."
        },
        {
        ...
        {
            question: "Do you transport freight outside New York?",
            answer: "Yes. Along with our Freight Service in New York, we provide nationwide freight transportation services across the United States."
        },
        {
                    ...
                    <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
                        ...
                        <div className="flex flex-col items-center text-center lg:items-start lg:text-left">
                            <div className="inline-flex items-center gap-2 bg-purple-50 border border-purple-200 px-4 py-1.5 rounded-full mb-6 shadow-sm">
                                <span className="text-purple-600 text-[11px] font-black tracking-widest uppercase">Reliable Freight Service in New York</span>
                            </div>

                            <h1 className="text-[42px] lg:text-[58px] font-[900] text-[#1a1b3a] leading-[1.1] mb-6 tracking-tighter uppercase">
                                Dependable Freight Solutions <span className="text-transparent bg-clip-text bg-gradient-to-r from-yellow-400 to-yellow-600">For New York Businesses</span>
                            </h1>

                            <p className="text-[16px] text-gray-500 font-medium mb-6 leading-relaxed max-w-[540px]">
                                PickItUp provides professional Freight Service in New York for businesses that need reliable, secure, and cost-effective transportation solutions. Whether you&apos;re shipping palletized goods, commercial freight, industrial equipment, or retail inventory, our experienced logistics team ensures every shipment is handled with care and delivered on time.
                            </p>
                        ...
                        <div className="relative flex items-center justify-center">
                            <div className="w-full relative aspect-[4/3] rounded-[2.5rem] overflow-hidden shadow-[0_45px_90px_-20px_rgba(250,204,21,0.25)] border-4 border-white">
                                <Image
                                    src="/freight.jpg"
                                    alt="Reliable Freight Service in New York"
                                    fill
            ...
            <section className="py-20 lg:py-24 bg-gray-50 bg-gradient-to-tr from-purple-50 via-white to-yellow-50 border-b border-gray-100">
                <div className="max-w-[1240px] mx-auto px-6 lg:px-10">
                    <div className="text-center mb-16 max-w-3xl mx-auto">
                        ...
                        <p className="text-lg text-gray-600 leading-relaxed font-medium">
                            Our Freight Service in New York supports businesses across a wide range of industries, including:
                        </p>
                    </div>
            ...
            <section className="py-20 lg:py-24 bg-gray-50 border-b border-gray-100">
                <div className="max-w-[1240px] mx-auto px-6 lg:px-10 text-center">
                    ...
                    <p className="text-lg text-gray-600 leading-relaxed font-medium max-w-3xl mx-auto mb-8">
                        Businesses choose PickItUp because we provide dependable Freight Service in New York backed by experienced logistics professionals, advanced transportation technology, and exceptional customer support. Whether you&apos;re searching for Freight Service Near Me or nationwide freight solutions, we&apos;re committed to helping your business move forward with confidence.
                    </p>
            ...
            <section className="py-24 bg-[#1a1b3a] text-white">
                <div className="max-w-[1240px] mx-auto px-6 lg:px-10 text-center">
                    ...
                    <p className="text-xl text-gray-300 font-medium max-w-2xl mx-auto mb-12">
                        Choose PickItUp for reliable Freight Service in New York that keeps your business moving. Whether you&apos;re searching for Freight Service Near Me or require nationwide freight transportation, our experienced logistics team is ready to provide safe, efficient, and cost-effective shipping solutions.
                    </p>
