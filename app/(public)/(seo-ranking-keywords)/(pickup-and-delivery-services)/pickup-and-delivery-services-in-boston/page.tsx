...
export const metadata: Metadata = {
    title: 'Professional Pickup and Delivery Services in Boston | PickItUp',
    description: 'Looking for Pickup and Delivery Services in Boston? PickItUp provides fast, secure, and reliable pickup and delivery solutions for businesses and individuals.',
};

export default function BostonPickupDeliveryPage() {
