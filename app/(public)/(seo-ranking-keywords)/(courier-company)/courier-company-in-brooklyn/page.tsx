...
export const metadata: Metadata = {
    title: 'Trusted Courier Company in Brooklyn | PickItUp',
    description: 'Looking for a reliable Courier Company in Brooklyn? PickItUp provides fast, secure, and professional courier and delivery solutions for businesses and individuals.',
};

export default function BrooklynCourierPage() {
    ...
    const regionalFaqs = [
        ...
        { question: `Do you provide courier services throughout ${location}?`, answer: `Yes. As a leading Courier Company in ${location}, we provide reliable pickup and delivery services across the area and throughout the United States.` },
