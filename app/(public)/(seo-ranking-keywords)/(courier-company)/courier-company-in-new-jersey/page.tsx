...
export const metadata: Metadata = {
    title: 'Trusted Courier Company in New Jersey | PickItUp',
    description: 'Looking for a reliable Courier Company in New Jersey? PickItUp provides fast, secure, and professional courier and delivery solutions for businesses and individuals.',
};

export default function NewJerseyCourierPage() {
        ...
        <div className="min-h-screen bg-white text-[#1a1b3a]">
                ...
                <div className="max-w-[1240px] mx-auto px-6 lg:px-10">
                    <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
                        <div className="flex flex-col items-center text-center lg:items-start lg:text-left">
                            ...
                            <p className="text-[16px] text-gray-500 font-medium mb-8 leading-relaxed max-w-[540px]">If you&apos;ve been searching for a Courier Company Near Me, PickItUp offers fast response times, professional drivers, and reliable service throughout {location}. Our flexible delivery solutions are designed to meet the needs of retailers, healthcare providers, law firms, e-commerce businesses, and many other industries.</p>
            ...
            <section className="py-20 lg:py-24 bg-gray-50 bg-gradient-to-tr from-purple-50 via-white to-yellow-50 border-b border-gray-100">
                <div className="max-w-[1240px] mx-auto px-6 lg:px-10">
                    <div className="text-center mb-16 max-w-3xl mx-auto">
                        ...
                        <p className="text-lg text-gray-600 leading-relaxed font-medium">Our Courier Company in {location} supports a wide range of industries, including:</p>
                    </div>
                    ...
                    <div className="text-center max-w-2xl mx-auto mt-10"><p className="text-md text-gray-500 font-bold leading-relaxed">Whether you&apos;re delivering important documents, retail orders, medical supplies, or commercial packages, PickItUp provides reliable courier solutions tailored to your business.</p></div>
                </div>
            </section>
                ...
                <div className="max-w-[1240px] mx-auto px-6 lg:px-10">
                    <div className="grid lg:grid-cols-2 gap-12 items-center">
                        <div>
                            ...
                            <p className="text-lg text-gray-600 leading-relaxed font-medium mb-6">Searching online for a Courier Company Near Me? PickItUp proudly serves customers throughout {location} while also offering nationwide delivery solutions. Whether your shipment is traveling across town or across the country, our logistics network ensures fast, secure, and dependable transportation.</p>
                            <p className="text-lg text-gray-600 leading-relaxed font-medium">Our goal is to make every delivery simple, efficient, and stress-free.</p>
                        </div>
            ...
            <section className="py-20 lg:py-24 bg-gray-50 border-b border-gray-100">
                <div className="max-w-[1240px] mx-auto px-6 lg:px-10 text-center">
                    ...
                    <p className="text-lg text-gray-600 leading-relaxed font-medium max-w-3xl mx-auto mb-6">At PickItUp, we understand that every package matters. That&apos;s why businesses and individuals trust our Courier Company in {location} for dependable delivery services backed by experienced professionals, modern technology, and exceptional customer support.</p>
                    <p className="text-lg text-gray-600 leading-relaxed font-medium max-w-3xl mx-auto mb-8">We are committed to helping our customers save time, improve efficiency, and deliver with confidence.</p>
