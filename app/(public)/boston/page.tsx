            ...
            <section className="bg-gradient-to-b from-gray-50 to-[#fdfaff] py-16 lg:py-24 border-b border-gray-100">
                <div className="max-w-[1240px] mx-auto px-6 lg:px-10 text-center">
                    ...
                    <h1 className="text-[42px] lg:text-[58px] font-[900] text-[#1a1b3a] leading-[1.1] mb-6 tracking-tighter uppercase max-w-4xl mx-auto">
                        Freight Service in <span className="text-transparent bg-clip-text bg-gradient-to-r from-yellow-400 to-yellow-600">Boston</span>
                    </h1>

                    <p className="text-lg text-gray-500 font-medium mb-10 max-w-2xl mx-auto leading-relaxed">
                        PickItUp provides professional and top-tier Freight Services in Boston. If you are looking for local pickup, efficient regional transit, and nationwide logistics matching, we have you covered. Content updates are coming soon.
                    </p>
            ...
            <section className="py-20 lg:py-24 bg-gray-50">
                <div className="max-w-4xl mx-auto px-6 text-center">
                    ...
                    <p className="text-gray-650 font-medium mb-12">
                        We are currently preparing full service details and schedules for businesses operating in Boston.
                    </p>
