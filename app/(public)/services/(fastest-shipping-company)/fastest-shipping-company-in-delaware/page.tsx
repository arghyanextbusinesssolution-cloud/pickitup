...
export const metadata: Metadata = {
    title: 'Fastest Shipping Company in Delaware | PickItUp',
    description: 'Looking for the fastest shipping company in Delaware? PickItUp provides same-day, next-day, and scheduled shipping solutions for businesses and individuals.',
};

export default function DelawareFastestShippingPage() {
    const regionalFaqs = [
        ...
        { question: "Do you provide fast shipping throughout Delaware?", answer: "Yes. As the Fastest Shipping Company in Delaware, we offer fast, reliable shipping services throughout the state and across the United States." },
        ...
        { question: "I searched for the \"Fastest Shipping Company Near Me.\" Do you provide local shipping?", answer: "Yes. If you're looking for the Fastest Shipping Company Near Me, PickItUp provides prompt pickup and delivery services throughout Delaware with flexible scheduling and reliable transportation." },
    ...
    const steps = [
        { src: '/find-shipments1.png', alt: 'Schedule Shipment Delaware', label: 'Step 1 – Schedule Your Shipment', desc: 'Provide your pickup location, destination, shipment details, and preferred delivery timeline. Our logistics team quickly prepares the most efficient shipping solution.' },
        { src: '/find-shipments2.png', alt: 'Fast Pickup Delaware', label: 'Step 2 – Fast Pickup', desc: 'Our professional drivers arrive on schedule to collect your shipment from your business, warehouse, or home.' },
        { src: '/find-shipments3.png', alt: 'Secure Transportation Delaware', label: 'Step 3 – Secure Transportation', desc: 'Your shipment travels through our optimized delivery network with continuous tracking and careful handling from pickup to destination.' },
        { src: '/find-shipments4.png', alt: 'On-Time Delivery Delaware', label: 'Step 4 – On-Time Delivery', desc: 'We deliver your shipment quickly and safely while keeping you informed throughout the shipping process.' }
    ];
        ...
        <div className="min-h-screen bg-white text-[#1a1b3a]">
                    ...
                    <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
                        <div className="flex flex-col items-center text-center lg:items-start lg:text-left">
                            <div className="inline-flex items-center gap-2 bg-purple-50 border border-purple-200 px-4 py-1.5 rounded-full mb-6 shadow-sm">
                                <span className="text-purple-600 text-[11px] font-black tracking-widest uppercase">Fastest Shipping Company in Delaware</span>
                            </div>
                            <h1 className="text-[42px] lg:text-[58px] font-[900] text-[#1a1b3a] leading-[1.1] mb-6 tracking-tighter uppercase">
                                Fastest Shipping Company <span className="text-transparent bg-clip-text bg-gradient-to-r from-yellow-400 to-yellow-600">in Delaware</span>
                            </h1>
                            ...
                            <p className="text-[16px] text-gray-500 font-medium mb-6 leading-relaxed max-w-[540px]">When speed matters, PickItUp delivers. As the Fastest Shipping Company in Delaware, we provide dependable shipping solutions for businesses and individuals who need packages, freight, and commercial shipments delivered quickly and securely.</p>
                        ...
                        <div className="relative flex items-center justify-center">
                            <div className="w-full relative aspect-[4/3] rounded-[2.5rem] overflow-hidden shadow-[0_45px_90px_-20px_rgba(250,204,21,0.25)] border-4 border-white">
                                <Image src="/freight.jpg" alt="Fastest Shipping Company in Delaware" fill className="object-cover" priority />
                ...
                <div className="max-w-[1240px] mx-auto px-6 lg:px-10">
                    <div className="grid lg:grid-cols-12 gap-12 items-start">
                        <div className="lg:col-span-7">
                            <h2 className="text-[32px] lg:text-[42px] font-[900] text-[#1a1b3a] tracking-tight uppercase mb-6 leading-tight">Why Choose the Fastest Shipping Company in Delaware?</h2>
            ...
            <section className="py-20 lg:py-24 bg-gray-50 bg-gradient-to-tr from-purple-50 via-white to-yellow-50 border-b border-gray-100">
                <div className="max-w-[1240px] mx-auto px-6 lg:px-10">
                    <div className="text-center mb-16 max-w-3xl mx-auto">
                        ...
                        <p className="text-lg text-gray-600 leading-relaxed font-medium">As the Fastest Shipping Company in Delaware, we support businesses in:</p>
                    </div>
                ...
                <div className="max-w-[1240px] mx-auto px-6 lg:px-10">
                    <div className="grid lg:grid-cols-2 gap-12 items-center">
                        <div>
                            ...
                            <h2 className="text-[32px] lg:text-[42px] font-[900] text-[#1a1b3a] tracking-tight uppercase mb-6 leading-tight">Fast Shipping Across Delaware and Beyond</h2>
                            <p className="text-lg text-gray-600 leading-relaxed font-medium mb-6">Searching online for the Fastest Shipping Company Near Me? PickItUp proudly serves customers throughout Delaware while providing reliable nationwide shipping services. From local deliveries to long-distance shipments, we provide dependable service tailored to your shipping needs.</p>
                        </div>
            ...
            <section className="py-20 lg:py-24 bg-gray-50 border-b border-gray-100">
                <div className="max-w-[1240px] mx-auto px-6 lg:px-10 text-center">
                    ...
                    <p className="text-lg text-gray-600 leading-relaxed font-medium max-w-3xl mx-auto mb-8">As the Fastest Shipping Company in Delaware, we focus on timely deliveries, transparent communication, and exceptional customer service to help our clients meet deadlines and exceed customer expectations.</p>
            ...
            <section className="py-24 bg-[#1a1b3a] text-white">
                <div className="max-w-[1240px] mx-auto px-6 lg:px-10 text-center">
                    ...
                    <p className="text-xl text-gray-300 font-medium max-w-3xl mx-auto mb-12">Partner with PickItUp, the Fastest Shipping Company in Delaware, for dependable pickup, secure transportation, and on-time delivery. Whether you&apos;re searching for the Fastest Shipping Company Near Me or need nationwide shipping solutions, we&apos;re ready to deliver.</p>
