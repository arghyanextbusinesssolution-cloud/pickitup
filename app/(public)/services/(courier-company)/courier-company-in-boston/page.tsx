...
export const metadata: Metadata = {
    title: 'Trusted Courier Company in Boston | PickItUp',
    description: 'Looking for a reliable Courier Company in Boston? PickItUp provides fast, secure, and professional courier and delivery solutions for businesses and individuals.',
};

export default function BostonCourierPage() {
