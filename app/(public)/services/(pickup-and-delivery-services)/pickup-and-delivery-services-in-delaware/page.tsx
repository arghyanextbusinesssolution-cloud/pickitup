...
export const metadata: Metadata = {
    title: 'Professional Pickup and Delivery Services in Delaware | PickItUp',
    description: 'Looking for Pickup and Delivery Services in Delaware? PickItUp provides fast, secure, and reliable pickup and delivery solutions for businesses and individuals.',
};

export default function DelawarePickupDeliveryPage() {
