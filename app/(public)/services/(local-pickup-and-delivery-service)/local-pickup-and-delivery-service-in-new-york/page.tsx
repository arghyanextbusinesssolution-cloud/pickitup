...
export const metadata: Metadata = {
    title: 'Reliable Local Pickup and Delivery Service in New York | PickItUp',
    description: 'Looking for a dependable Local Pickup and Delivery Service in New York? PickItUp provides professional pickup and delivery solutions for businesses and individuals.',
};

export default function NewYorkLocalPickupPage() {
    const regionalFaqs = [
        ...
        { question: "Do you provide Local Pickup and Delivery Service in New York?", answer: "Yes. PickItUp specializes in Local Pickup and Delivery Service in New York, helping businesses and individuals with fast, secure, and reliable transportation throughout the state." },
        ...
        { question: "I searched for a \"Local Pickup and Delivery Service Near Me.\" Can you help?", answer: "Yes. If you're looking for a Local Pickup and Delivery Service Near Me, PickItUp provides prompt pickup and delivery services throughout New York with flexible scheduling and dependable customer support." },
    ...
    const steps = [
        { src: '/find-shipments1.png', alt: 'Schedule Pickup New York', label: 'Step 1 – Schedule Your Pickup', desc: 'Book your pickup online or contact our team with your pickup location, destination, package details, and preferred delivery time.' },
        { src: '/find-shipments2.png', alt: 'Collect Shipment New York', label: 'Step 2 – We Collect Your Shipment', desc: 'Our professional driver arrives promptly to collect your package, documents, or freight from your home, office, warehouse, or business location.' },
        { src: '/find-shipments3.png', alt: 'Transportation New York', label: 'Step 3 – Safe & Efficient Transportation', desc: 'Your shipment is transported using optimized delivery routes with continuous tracking and careful handling to ensure safe arrival.' },
        { src: '/find-shipments4.png', alt: 'Delivered On Time New York', label: 'Step 4 – Delivered On Time', desc: 'We complete your delivery quickly and efficiently while keeping you updated throughout the entire process.' }
    ];
        ...
        <div className="min-h-screen bg-white text-[#1a1b3a]">
                    ...
                    <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
                        <div className="flex flex-col items-center text-center lg:items-start lg:text-left">
                            <div className="inline-flex items-center gap-2 bg-purple-50 border border-purple-200 px-4 py-1.5 rounded-full mb-6 shadow-sm">
                                <span className="text-purple-600 text-[11px] font-black tracking-widest uppercase">Local Pickup and Delivery Service in New York</span>
                            </div>
                            <h1 className="text-[42px] lg:text-[58px] font-[900] text-[#1a1b3a] leading-[1.1] mb-6 tracking-tighter uppercase">
                                Reliable Local Pickup and Delivery Service <span className="text-transparent bg-clip-text bg-gradient-to-r from-yellow-400 to-yellow-600">in New York</span>
                            </h1>
                            ...
                            <p className="text-[16px] text-gray-500 font-medium mb-6 leading-relaxed max-w-[540px]">Looking for a dependable Local Pickup and Delivery Service in New York? PickItUp provides professional pickup and delivery solutions for businesses and individuals who need fast, secure, and on-time transportation. Our experienced team ensures every delivery is handled with care.</p>
                            <p className="text-[16px] text-gray-500 font-medium mb-8 leading-relaxed max-w-[540px]">If you&apos;ve been searching for a Local Pickup and Delivery Service Near Me, PickItUp offers flexible scheduling, same-day service options, real-time tracking, and dependable customer support throughout New York.</p>
                        ...
                        <div className="relative flex items-center justify-center">
                            <div className="w-full relative aspect-[4/3] rounded-[2.5rem] overflow-hidden shadow-[0_45px_90px_-20px_rgba(250,204,21,0.25)] border-4 border-white">
                                <Image src="/freight.jpg" alt="Local Pickup and Delivery Service in New York" fill className="object-cover" priority />
                                ...
                                <div className="absolute bottom-6 left-6 text-white font-bold">
                                    ...
                                    <div className="text-xl">PickItUp New York Hub</div>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div className="max-w-[1240px] mx-auto px-6 lg:px-10">
                    <div className="grid lg:grid-cols-12 gap-12 items-start">
                        <div className="lg:col-span-7">
                            ...
                            <p className="text-lg text-gray-600 leading-relaxed font-medium mb-6">Our Local Pickup and Delivery Service in New York is designed to provide dependable transportation with flexible scheduling, professional drivers, and outstanding customer service.</p>
            ...
            <section className="py-20 lg:py-24 bg-gray-50 bg-gradient-to-tr from-purple-50 via-white to-yellow-50 border-b border-gray-100">
                <div className="max-w-[1240px] mx-auto px-6 lg:px-10">
                    <div className="text-center mb-16 max-w-3xl mx-auto">
                        <h2 className="text-[32px] lg:text-[42px] font-[900] text-[#1a1b3a] tracking-tight uppercase mb-4 leading-tight">Serving Businesses Across New York</h2>
                        <p className="text-lg text-gray-600 leading-relaxed font-medium">Our Local Pickup and Delivery Service in New York supports businesses across multiple industries:</p>
                    </div>
                ...
                <div className="max-w-[1240px] mx-auto px-6 lg:px-10">
                    <div className="grid lg:grid-cols-2 gap-12 items-center">
                        <div>
                            ...
                            <p className="text-lg text-gray-600 leading-relaxed font-medium mb-6">Searching for a Local Pickup and Delivery Service Near Me? PickItUp proudly serves communities throughout New York with prompt and dependable delivery services, plus nationwide shipping options.</p>
                        </div>
            ...
            <section className="py-20 lg:py-24 bg-gray-50 border-b border-gray-100">
                <div className="max-w-[1240px] mx-auto px-6 lg:px-10 text-center">
                    ...
                    <p className="text-lg text-gray-600 leading-relaxed font-medium max-w-3xl mx-auto mb-8">Our Local Pickup and Delivery Service in New York helps businesses improve efficiency while giving individuals peace of mind that their shipments will arrive safely and on time.</p>
            ...
            <section className="py-24 bg-[#1a1b3a] text-white">
                <div className="max-w-[1240px] mx-auto px-6 lg:px-10 text-center">
                    ...
                    <p className="text-xl text-gray-300 font-medium max-w-3xl mx-auto mb-12">Choose PickItUp for a dependable Local Pickup and Delivery Service in New York. Whether you&apos;re searching for a Local Pickup and Delivery Service Near Me or need ongoing business delivery solutions, our team is ready to help.</p>
