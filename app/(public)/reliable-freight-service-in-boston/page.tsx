...
export const metadata: Metadata = {
    title: 'Reliable Freight Service in Boston | PickItUp',
    description: 'Looking for reliable freight service in Boston? PickItUp offers fast, secure, and affordable freight shipping solutions for businesses and individuals.',
};
