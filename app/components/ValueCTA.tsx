                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                    ...
                    <div className="text-white flex flex-col items-center text-center lg:items-start lg:text-left mx-auto lg:mx-0">
                        ...
                        <div className="flex flex-wrap items-center justify-center lg:justify-start gap-8 mb-16">
                            <button className="bg-yellow-400 hover:bg-yellow-500 text-[#1a1b3a] font-[900] px-10 py-4 rounded-xl transition-all shadow-xl shadow-yellow-400/20 flex items-center gap-3 group text-sm uppercase tracking-widest">
                                Get Started
