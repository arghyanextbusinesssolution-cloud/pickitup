        ...
        <section className="bg-gradient-to-b from-gray-50 to-white py-12 lg:py-20">
            <div className="max-w-[1240px] mx-auto px-6 lg:px-10">
                <div className="grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
                    ...
                    <div className="flex flex-col items-center text-center lg:items-start lg:text-left px-2">
                        ...
                        <div className="bg-white rounded-[2.5rem] shadow-[0_30px_60px_-15px_rgba(0,0,0,0.1)] p-6 sm:p-8 mb-8 border border-gray-100 w-full max-w-[580px] mx-auto lg:mx-0">
                            ...
                            <div className="flex flex-col sm:flex-row gap-3">
                                <button className="flex-1 bg-yellow-400 hover:bg-yellow-500 text-[#1a1b3a] font-[900] px-6 py-4 rounded-xl transition-all shadow-lg shadow-yellow-400/20 flex items-center justify-center gap-2 group text-[15px]">
                                    Get Shipping Quotes
                                </button>
                                <button className="flex-1 border border-[#4b148c] text-[#4b148c] hover:bg-purple-50 font-[900] px-6 py-4 rounded-xl transition-all flex items-center justify-center gap-2 text-[15px]">
                                    Become a Carrier
                                </button>
                            </div>
                        </div>
                    ...
                    {/* Right Column - Image Card - PIXEL PERFECT RECTANGLE */}
